...
document.addEventListener('DOMContentLoaded', function() {
        ...
        if (filteredExpenses.length === 0) {
            expensesList.innerHTML = `
                <div class="empty-state cyber-empty">
                    ...
                    <h3>NO SIGNAL</h3>
                    <p>${filterValue === 'all' ? 'Awaiting data transmission...' : 'No telemetry in this sector'}</p>
                </div>
            `;
            return;
        }
    ...
    function updateCategoryBreakdown() {
        if (expenses.length === 0) {
            categoryBreakdown.innerHTML = `
                <div class="empty-state cyber-empty">
                    <p>Insufficient telemetry for analysis.</p>
                </div>
            `;
            return;
        }
    ...
    function clearForm() {
        ...
        editMode = false;
        currentEditId = null;
        document.querySelector('.primary').innerHTML = '<span class="btn-text"><i class="fas fa-upload"></i> TRANSMIT</span><div class="btn-glitch"></div>';
    }
    ...
    window.editExpense = function(id) {
        ...
        if (expense) {
            ...
            // Update button text
            document.querySelector('.primary').innerHTML = '<span class="btn-text"><i class="fas fa-save"></i> UPDATE TRANSMISSION</span><div class="btn-glitch"></div>';
